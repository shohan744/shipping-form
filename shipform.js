window.onload = function() {
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(event) {
            ...
            var hasBatteries = document.getElementById('batteries-yes').checked ? 'Yes' : 'No';
...
function validateForm() {
    ...
    // For example:
    if (document.getElementById('postageAccount').value.trim() === '') {
        alert('Please enter the Postage Account.');
        return false;
    }
    // more validation checks here maybe
    return true;
}
